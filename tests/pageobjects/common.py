...
class CommonPageObject(PageObject):
    ...
    def getMessage(self):
        messageElement = Text(By.XPATH, "//div[@class='modal-dialog']//div[@class='modal-body']");
        return messageElement.wait_until_visible(10).text;

    def getContentSection(self):
        return PageElement(By.ID, "app-wrap");
